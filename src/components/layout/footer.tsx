  ...
  return (
    <footer className="border-t bg-background/80 backdrop-blur-sm">
      <div className="container py-4 text-center text-xs text-muted-foreground">
        <div className="mb-2 space-y-1 p-2 border-l-4 border-destructive bg-destructive/10 rounded-r-lg text-left">
            <p className="font-bold text-destructive-foreground">
              “본 서비스는 의료적 자문이 아니며, 약물 판매와 무관합니다. 모든 처방은 의료 전문가와 상담 후 결정하세요.”
            </p>
             <p className="font-bold text-destructive-foreground/80">
