    ...
    const handlePredict = async ()=>{
        ...
        try {
            const allClinicReports = [
                ...__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$mock$2d$data$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["reports"].filter((r)=>r.clinicId === clinic.id && r.item === item),
                ...__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$mock$2d$data$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["clinics"].filter((c)=>c.id === clinic.id).map((c)=>({
                        id: `admin-${c.id}-${item}`,
                        clinicId: c.id,
                        clinicName: c.name,
                        item: item,
...
_s(AvailabilityPredictor, "O0HWj+QDA1/QopGRcbjO5O5Zv28=");
...
function MapView({ clinics, filters }) {
    ...
    const getMarkerInfo = (clinic)=>{
        ...
        let pulse = false;
        if (status === 'available') {
            color = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$mock$2d$data$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["items"].find((i)=>i.id === product)?.color || '#16a34a';
...
_s(MapView, "gHhyrSpW67KzvrIVVOMDvyk8mAM=");
_c = MapView;
var _c;
...
async function getReportsFromFirestore() {
    ...
    try {
        ...
        const reportSnapshot = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$esm2017$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getDocs"])(q);
...
function Home() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "Home.useEffect": ()=>{
            document.title = `${__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$mock$2d$data$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["items"].find({
                "Home.useEffect": (i)=>i.id === activeTab
            }["Home.useEffect"])?.displayNameKo} 재고 지도 | GLP 트래커`;
        }
    }["Home.useEffect"], [
        activeTab
    ]);
    ...
    const reports = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "Home.useMemo[reports]": ()=>{
            const adminReports = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$mock$2d$data$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["clinics"].map({
                "Home.useMemo[reports].adminReports": (clinic)=>{
                    const wegovyReport = {
                        clinicId: clinic.id,
                        clinicName: clinic.name,
                        item: 'wegovy',
            ...
            }["Home.useMemo[reports].adminReports"]).flat();
            return [
                ...firestoreReports,
                ...adminReports
            ];
    ...
    const availableClinicsForProduct = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "Home.useMemo[availableClinicsForProduct]": ()=>__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$mock$2d$data$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["clinics"].filter({
                "Home.useMemo[availableClinicsForProduct]": (c)=>c.status[activeTab] === 'available' && c.price[activeTab]
            }["Home.useMemo[availableClinicsForProduct]"])
    }["Home.useMemo[availableClinicsForProduct]"], [
        activeTab
    ]);
    const [minPrice, maxPrice] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "Home.useMemo": ()=>{
            ...
            const prices = availableClinicsForProduct.map({
                "Home.useMemo.prices": (c)=>c.price[activeTab]
            }["Home.useMemo.prices"]).filter({
                "Home.useMemo.prices": (p)=>p !== undefined && p !== null
            }["Home.useMemo.prices"]);
    ...
    const filteredClinics = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "Home.useMemo[filteredClinics]": ()=>{
            return __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$mock$2d$data$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["clinics"].filter({
                "Home.useMemo[filteredClinics]": (clinic)=>{
                    ...
                    const latestReport = [
                        ...
                        "Home.useMemo[filteredClinics]": (r)=>r.clinicId === clinic.id
                    }["Home.useMemo[filteredClinics]"]).sort({
                        "Home.useMemo[filteredClinics]": (a, b)=>b._date.getTime() - a._date.getTime()
                    }["Home.useMemo[filteredClinics]"])[0];
                ...
                children: [
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: [
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                className: "absolute bottom-4 left-4 z-10 bg-black/50 text-white text-xs p-2 rounded-md max-w-xs md:max-w-sm flex items-start gap-2",
                                children: [
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lucide$2d$react$2f$dist$2f$esm$2f$icons$2f$info$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__Info$3e$__["Info"], {
...
_s(Home, "G0DHd4D8dt2w3xorStV58H2Nhko=");
_c = Home;
var _c;
...
//# sourceMappingURL=src_171632b7._.js.map