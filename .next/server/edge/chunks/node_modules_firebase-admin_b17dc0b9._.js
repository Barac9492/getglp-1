(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["chunks/node_modules_firebase-admin_b17dc0b9._.js", {

"[project]/node_modules/firebase-admin/lib/app [middleware-edge] (ecmascript)": (function(__turbopack_context__) {
...
"[project]/node_modules/firebase-admin/lib/utils/deep-copy.js [middleware-edge] (ecmascript)": (function(__turbopack_context__) {
...
"[project]/node_modules/firebase-admin/lib/utils/error.js [middleware-edge] (ecmascript)": (function(__turbopack_context__) {
...
const deep_copy_1 = __turbopack_context__.r("[project]/node_modules/firebase-admin/lib/utils/deep-copy.js [middleware-edge] (ecmascript)");
/**
...
"[project]/node_modules/firebase-admin/lib/utils [middleware-edge] (ecmascript)": (function(__turbopack_context__) {

var { g: global, __dirname, m: module, e: exports } = __turbopack_context__;
{
__turbopack_context__.n(__import_unsupported(`zlib`));
}}),
"[project]/node_modules/firebase-admin/lib/utils/validator.js [middleware-edge] (ecmascript)": (function(__turbopack_context__) {

var { g: global, __dirname, m: module, e: exports } = __turbopack_context__;
{
/*! firebase-admin v12.7.0 */ var __TURBOPACK__imported__module__$5b$externals$5d2f$node$3a$buffer__$5b$external$5d$__$28$node$3a$buffer$2c$__cjs$29$__ = __turbopack_context__.i("[externals]/node:buffer [external] (node:buffer, cjs)");
"use strict";
/*!
 * @license
 * Copyright 2017 Google Inc.
...
const url = __turbopack_context__.r("[project]/node_modules/next/dist/compiled/native-url/index.js [middleware-edge] (ecmascript)");
/**
 ...
 */ function isBuffer(value) {
    return value instanceof __TURBOPACK__imported__module__$5b$externals$5d2f$node$3a$buffer__$5b$external$5d$__$28$node$3a$buffer$2c$__cjs$29$__["Buffer"];
}
...
"[project]/node_modules/firebase-admin/lib/utils/api-request.js [middleware-edge] (ecmascript)": (function(__turbopack_context__) {
...
const error_1 = __turbopack_context__.r("[project]/node_modules/firebase-admin/lib/utils/error.js [middleware-edge] (ecmascript)");
const validator = __turbopack_context__.r("[project]/node_modules/firebase-admin/lib/utils/validator.js [middleware-edge] (ecmascript)");
const http = __turbopack_context__.r("[project]/node_modules/firebase-admin/lib/utils [middleware-edge] (ecmascript)");
const https = __turbopack_context__.r("[project]/node_modules/firebase-admin/lib/utils [middleware-edge] (ecmascript)");
const http2 = __turbopack_context__.r("[project]/node_modules/firebase-admin/lib/utils [middleware-edge] (ecmascript)");
const url = __turbopack_context__.r("[project]/node_modules/next/dist/compiled/native-url/index.js [middleware-edge] (ecmascript)");
 ...
 */ class AsyncRequestCall {
    ...
    handleMultipartResponse(response, respStream, boundary) {
        const busboy = __turbopack_context__.r("[project]/node_modules/@fastify/busboy/lib/main.js [middleware-edge] (ecmascript)"); // eslint-disable-line @typescript-eslint/no-var-requires
        ...
        multipartParser.on('part', (part)=>{
            ...
            part.on('end', ()=>{
                responseBuffer.push(__TURBOPACK__imported__module__$5b$externals$5d2f$node$3a$buffer__$5b$external$5d$__$28$node$3a$buffer$2c$__cjs$29$__["Buffer"].concat(tempBuffers));
            });
        });
    ...
    handleRegularResponse(response, respStream) {
        ...
        respStream.on('end', ()=>{
            response.data = __TURBOPACK__imported__module__$5b$externals$5d2f$node$3a$buffer__$5b$external$5d$__$28$node$3a$buffer$2c$__cjs$29$__["Buffer"].concat(responseBuffer).toString();
            this.finalizeResponse(response);
        });
    }
    /**
 ...
 */ class AsyncHttpCall extends AsyncRequestCall {
    ...
    uncompressResponse(res) {
        ...
        if (res.headers['content-encoding'] && encodings.indexOf(res.headers['content-encoding']) !== -1) {
            ...
            const zlib = __turbopack_context__.r("[project]/node_modules/firebase-admin/lib/utils [middleware-edge] (ecmascript)"); // eslint-disable-line @typescript-eslint/no-var-requires
 ...
 */ class BaseRequestConfigImpl {
    ...
    buildEntity(headers) {
        ...
        if (validator.isBuffer(this.data)) {
            ...
            data = __TURBOPACK__imported__module__$5b$externals$5d2f$node$3a$buffer__$5b$external$5d$__$28$node$3a$buffer$2c$__cjs$29$__["Buffer"].from(JSON.stringify(this.data), 'utf-8');
            if (typeof headers['content-type'] === 'undefined') {
                headers['content-type'] = 'application/json;charset=utf-8';
            }
        } else if (validator.isString(this.data)) {
            data = __TURBOPACK__imported__module__$5b$externals$5d2f$node$3a$buffer__$5b$external$5d$__$28$node$3a$buffer$2c$__cjs$29$__["Buffer"].from(this.data, 'utf-8');
        } else {
...
"[project]/node_modules/firebase-admin/lib/app/credential-internal.js [middleware-edge] (ecmascript)": (function(__turbopack_context__) {
...
const fs = __turbopack_context__.r("[project]/node_modules/firebase-admin/lib/app [middleware-edge] (ecmascript)");
const os = __turbopack_context__.r("[project]/node_modules/firebase-admin/lib/app [middleware-edge] (ecmascript)");
const path = __turbopack_context__.r("[project]/node_modules/firebase-admin/lib/app [middleware-edge] (ecmascript)");
const error_1 = __turbopack_context__.r("[project]/node_modules/firebase-admin/lib/utils/error.js [middleware-edge] (ecmascript)");
const api_request_1 = __turbopack_context__.r("[project]/node_modules/firebase-admin/lib/utils/api-request.js [middleware-edge] (ecmascript)");
const util = __turbopack_context__.r("[project]/node_modules/firebase-admin/lib/utils/validator.js [middleware-edge] (ecmascript)");
 ...
 */ class ServiceAccountCredential {
    ...
    createAuthJwt_() {
        ...
        const jwt = __turbopack_context__.r("[project]/node_modules/jsonwebtoken/index.js [middleware-edge] (ecmascript)");
 ...
 */ class ServiceAccount {
    ...
    constructor(json){
        ...
        // eslint-disable-next-line @typescript-eslint/no-var-requires
        const forge = __turbopack_context__.r("[project]/node_modules/node-forge/lib/index.js [middleware-edge] (ecmascript)");
        try {
...
"[project]/node_modules/firebase-admin/lib/utils/index.js [middleware-edge] (ecmascript)": (function(__turbopack_context__) {
...
const credential_internal_1 = __turbopack_context__.r("[project]/node_modules/firebase-admin/lib/app/credential-internal.js [middleware-edge] (ecmascript)");
const validator = __turbopack_context__.r("[project]/node_modules/firebase-admin/lib/utils/validator.js [middleware-edge] (ecmascript)");
let sdkVersion;
...
"[project]/node_modules/firebase-admin/lib/app/firebase-app.js [middleware-edge] (ecmascript)": (function(__turbopack_context__) {
...
"[project]/node_modules/firebase-admin/lib/app/lifecycle.js [middleware-edge] (ecmascript)": (function(__turbopack_context__) {
...
const error_1 = __turbopack_context__.r("[project]/node_modules/firebase-admin/lib/utils/error.js [middleware-edge] (ecmascript)");
const credential_internal_1 = __turbopack_context__.r("[project]/node_modules/firebase-admin/lib/app/credential-internal.js [middleware-edge] (ecmascript)");
const firebase_app_1 = __turbopack_context__.r("[project]/node_modules/firebase-admin/lib/app/firebase-app.js [middleware-edge] (ecmascript)");
...
"[project]/node_modules/firebase-admin/lib/app/credential-factory.js [middleware-edge] (ecmascript)": (function(__turbopack_context__) {
...
"[project]/node_modules/firebase-admin/lib/app/index.js [middleware-edge] (ecmascript)": (function(__turbopack_context__) {
...
const utils_1 = __turbopack_context__.r("[project]/node_modules/firebase-admin/lib/utils/index.js [middleware-edge] (ecmascript)");
var lifecycle_1 = __turbopack_context__.r("[project]/node_modules/firebase-admin/lib/app/lifecycle.js [middleware-edge] (ecmascript)");
...
var credential_factory_1 = __turbopack_context__.r("[project]/node_modules/firebase-admin/lib/app/credential-factory.js [middleware-edge] (ecmascript)");
...
var error_1 = __turbopack_context__.r("[project]/node_modules/firebase-admin/lib/utils/error.js [middleware-edge] (ecmascript)");
...
"[project]/node_modules/firebase-admin/lib/esm/app/index.js [middleware-edge] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$firebase$2d$admin$2f$lib$2f$app$2f$index$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/firebase-admin/lib/app/index.js [middleware-edge] (ecmascript)");
;
const AppErrorCodes = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$firebase$2d$admin$2f$lib$2f$app$2f$index$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["default"].AppErrorCodes;
const FirebaseAppError = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$firebase$2d$admin$2f$lib$2f$app$2f$index$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["default"].FirebaseAppError;
const SDK_VERSION = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$firebase$2d$admin$2f$lib$2f$app$2f$index$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["default"].SDK_VERSION;
const applicationDefault = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$firebase$2d$admin$2f$lib$2f$app$2f$index$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["default"].applicationDefault;
const cert = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$firebase$2d$admin$2f$lib$2f$app$2f$index$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["default"].cert;
const deleteApp = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$firebase$2d$admin$2f$lib$2f$app$2f$index$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["default"].deleteApp;
const getApp = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$firebase$2d$admin$2f$lib$2f$app$2f$index$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["default"].getApp;
const getApps = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$firebase$2d$admin$2f$lib$2f$app$2f$index$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["default"].getApps;
const initializeApp = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$firebase$2d$admin$2f$lib$2f$app$2f$index$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["default"].initializeApp;
const refreshToken = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$firebase$2d$admin$2f$lib$2f$app$2f$index$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["default"].refreshToken;
}}),
"[project]/node_modules/firebase-admin/lib/firestore/firestore-internal.js [middleware-edge] (ecmascript)": (function(__turbopack_context__) {
...
const credential_internal_1 = __turbopack_context__.r("[project]/node_modules/firebase-admin/lib/app/credential-internal.js [middleware-edge] (ecmascript)");
const validator = __turbopack_context__.r("[project]/node_modules/firebase-admin/lib/utils/validator.js [middleware-edge] (ecmascript)");
const utils = __turbopack_context__.r("[project]/node_modules/firebase-admin/lib/utils/index.js [middleware-edge] (ecmascript)");
...
function initFirestore(app, databaseId, firestoreSettings) {
    ...
    try {
        ...
        firestoreDatabase = __turbopack_context__.r("[project]/node_modules/@google-cloud/firestore/build/src/index.js [middleware-edge] (ecmascript)").Firestore;
    } catch (err) {
        throw new error_1.FirebaseFirestoreError({
...
"[project]/node_modules/firebase-admin/lib/firestore/index.js [middleware-edge] (ecmascript)": (function(__turbopack_context__) {
...
const app_1 = __turbopack_context__.r("[project]/node_modules/firebase-admin/lib/app/index.js [middleware-edge] (ecmascript)");
const firestore_internal_1 = __turbopack_context__.r("[project]/node_modules/firebase-admin/lib/firestore/firestore-internal.js [middleware-edge] (ecmascript)");
...
var firestore_1 = __turbopack_context__.r("[project]/node_modules/@google-cloud/firestore/build/src/index.js [middleware-edge] (ecmascript)");
...
"[project]/node_modules/firebase-admin/lib/esm/firestore/index.js [middleware-edge] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$firebase$2d$admin$2f$lib$2f$firestore$2f$index$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/firebase-admin/lib/firestore/index.js [middleware-edge] (ecmascript)");
;
const AggregateField = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$firebase$2d$admin$2f$lib$2f$firestore$2f$index$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["default"].AggregateField;
const AggregateQuery = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$firebase$2d$admin$2f$lib$2f$firestore$2f$index$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["default"].AggregateQuery;
const AggregateQuerySnapshot = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$firebase$2d$admin$2f$lib$2f$firestore$2f$index$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["default"].AggregateQuerySnapshot;
const BulkWriter = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$firebase$2d$admin$2f$lib$2f$firestore$2f$index$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["default"].BulkWriter;
const BundleBuilder = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$firebase$2d$admin$2f$lib$2f$firestore$2f$index$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["default"].BundleBuilder;
const CollectionGroup = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$firebase$2d$admin$2f$lib$2f$firestore$2f$index$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["default"].CollectionGroup;
const CollectionReference = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$firebase$2d$admin$2f$lib$2f$firestore$2f$index$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["default"].CollectionReference;
const DocumentReference = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$firebase$2d$admin$2f$lib$2f$firestore$2f$index$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["default"].DocumentReference;
const DocumentSnapshot = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$firebase$2d$admin$2f$lib$2f$firestore$2f$index$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["default"].DocumentSnapshot;
const FieldPath = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$firebase$2d$admin$2f$lib$2f$firestore$2f$index$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["default"].FieldPath;
const FieldValue = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$firebase$2d$admin$2f$lib$2f$firestore$2f$index$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["default"].FieldValue;
const Filter = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$firebase$2d$admin$2f$lib$2f$firestore$2f$index$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["default"].Filter;
const FirebaseFirestoreError = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$firebase$2d$admin$2f$lib$2f$firestore$2f$index$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["default"].FirebaseFirestoreError;
const Firestore = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$firebase$2d$admin$2f$lib$2f$firestore$2f$index$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["default"].Firestore;
const GeoPoint = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$firebase$2d$admin$2f$lib$2f$firestore$2f$index$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["default"].GeoPoint;
const GrpcStatus = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$firebase$2d$admin$2f$lib$2f$firestore$2f$index$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["default"].GrpcStatus;
const Query = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$firebase$2d$admin$2f$lib$2f$firestore$2f$index$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["default"].Query;
const QueryDocumentSnapshot = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$firebase$2d$admin$2f$lib$2f$firestore$2f$index$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["default"].QueryDocumentSnapshot;
const QueryPartition = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$firebase$2d$admin$2f$lib$2f$firestore$2f$index$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["default"].QueryPartition;
const QuerySnapshot = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$firebase$2d$admin$2f$lib$2f$firestore$2f$index$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["default"].QuerySnapshot;
const Timestamp = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$firebase$2d$admin$2f$lib$2f$firestore$2f$index$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["default"].Timestamp;
const Transaction = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$firebase$2d$admin$2f$lib$2f$firestore$2f$index$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["default"].Transaction;
const WriteBatch = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$firebase$2d$admin$2f$lib$2f$firestore$2f$index$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["default"].WriteBatch;
const WriteResult = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$firebase$2d$admin$2f$lib$2f$firestore$2f$index$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["default"].WriteResult;
const getFirestore = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$firebase$2d$admin$2f$lib$2f$firestore$2f$index$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["default"].getFirestore;
const initializeFirestore = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$firebase$2d$admin$2f$lib$2f$firestore$2f$index$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["default"].initializeFirestore;
const setLogFunction = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$firebase$2d$admin$2f$lib$2f$firestore$2f$index$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["default"].setLogFunction;
const v1 = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$firebase$2d$admin$2f$lib$2f$firestore$2f$index$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["default"].v1;
}}),
}]);

//# sourceMappingURL=node_modules_firebase-admin_b17dc0b9._.js.map